            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    ...
                    <DataTable v-model:filters="filters" :value="students" paginator showGridlines :rows="10" dataKey="id"
                        filterDisplay="menu" :globalFilterFields="['name', 'birth', 'sex', 'cpf', 'address', 'classroom_name']">
                        <template #header>
                        ...
                        <Column headerStyle="width:4rem" header="Ações" field="actions" href="{{ route('classroom.edit', $) }}">
                            <template #body="{ data }">
                                <button type="submit">
