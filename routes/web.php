...
Route::middleware([
    ...
    Route::post('update-escola/{id}', [SchoolController::class, 'update'])->name('school.update')->middleware([Precognition::class]);;
    ...
    Route::post('update-aluno/{id}', [StudentController::class, 'update'])->name('student.update')->middleware([Precognition::class]);;
